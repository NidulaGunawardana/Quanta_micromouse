...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOC,
			LED10_Pin | D_C_Pin | CE_Pin | CS_Pin | LED3_Pin | LED4_Pin
	...
	/*Configure GPIO pins : LED10_Pin D_C_Pin CE_Pin CS_Pin
	 LED3_Pin LED4_Pin LED5_Pin */
	GPIO_InitStruct.Pin = LED10_Pin | D_C_Pin | CE_Pin | CS_Pin | LED3_Pin
			| LED4_Pin | LED5_Pin;
	...
	/*Configure GPIO pins : PB2 INT_Pin PB14 BOOT0_Pin */
	GPIO_InitStruct.Pin = GPIO_PIN_2 | INT_Pin | GPIO_PIN_14 | BOOT0_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
